...
?>
        ...
        <div class="container">
          ...
          <div class="btn-group">
            ...
            <button class="btn btn-primary">
              <a href="https://store.steampowered.com"><span>Watch live</span></a>
          ...
          <div class="container">
            ...
            <ul class="gallery-list has-scrollbar">
              ...
              <li>
                <figure class="gallery-item">
                  ...
                  <a href="tic tac toe.html">
                    <img src="assets/images/tictactoe.png" alt="tictactoe" width="100" height="450">
              ...
              <li>
                <figure class="gallery-item">
                  <a href="doodle.html">
                    <img src="./assets/images/doodleJumpBG.jpeg" alt="Gallery image">
                  </a>
                </figure>
              </li>
  ...
  <footer>
        ...
        <div class="footer-brand-wrapper">
          ...
          <div class="footer-menu-wrapper">
            ...
            <ul class="footer-menu-list">
              ...
              <li>
                <a href="contact.php" class="footer-menu-link">Contact</a>
              </li>
          ...
          <ul class="footer-social-list">
            ...
            <li>
              ...
              <form action="logout.php" method="post">
                <button class="btn-sign_in" type="submit">
    ...
    <div class="footer-bottom">
      <div class="container">
        <p class="copyright">
          copyright 2024 <a href="#">GameSpace</a>. all rights reserved
        </p>
