...
<div class="container">
  ...
  <nav class="navbar" data-nav>
    ...
    <ul class="navbar-list">
      ...
      <li>
        <a href="admin_orders.php" class="navbar-link">Orders</a>
      </li>
...
<figure class="about-banner">
  ...
  <img src="./assets/images/character-3.png" alt="Game character" class="character character-3">
    ...
    <div class=about-content>
     ...
     <h2 align="center" class="about-title">User records</h2>
     <table align="center" border="1" cellspacing="7" width="100%">
        <tr>
            <th width="8%"><p class="about-text">Username</p></th>
            <th width="25%"><p class="about-text">Email</p></th>
            <th width="10%"><p class="about-text">Password</p></th>
            <th><p class="about-text">Update or Delete</p></th>
        </tr>
        <?php
        ...
        while ($result = mysqli_fetch_assoc($data)) {
            ?>
            <tr>
                <td><p class="about-text"><?php echo $result['username']; ?></p></td>
                <td><p class="about-text"><?php echo $result['email']; ?></p></td>
                <td><p class="about-text"><?php echo $result['password']; ?>
                <td><p class="about-text"><a href="admin_update.php?&em=<?php echo urlencode($result['email']); ?>">
                        <input type="submit" value="Update" name="" id="">
                    </a><a href="delete.php?&em=<?php echo urlencode($result['email']); ?>">
                        <input type="submit" value="Delete" name="" id="" onclick='return checkdelete()'>
                    </a></p></td>
            </tr>
            <?php
        }
